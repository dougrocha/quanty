...
export type UserQuery = { __typename?: 'Query', user: { __typename?: 'UserObject', username: string, discordID: string, avatar: string, discriminator: string, email?: string | null | undefined, verified?: boolean | null | undefined, flags?: number | null | undefined, locale?: string | null | undefined } };

export type OwnerGuildsQueryVariables = Exact<{ [key: string]: never; }>;


export type OwnerGuildsQuery = { __typename?: 'Query', ownerGuilds: Array<{ __typename?: 'Guild', id: string, owner?: boolean | null | undefined, icon: string }> };
...
export type GuildsQuery = { __typename?: 'Query', guilds: { __typename?: 'Guild', id: string, name: string, icon: string, afk_timeout: number, roles: Array<{ __typename?: 'Roles', id: string, name: string }> } };
...
export type GuildConfigQuery = { __typename?: 'Query', guildConfig: { __typename?: 'GuildConfig', guildId: string, prefix?: string | null | undefined, blacklistedWords?: Array<string> | null | undefined, premium?: boolean | null | undefined, moderation?: { __typename?: 'Moderation', autoMod?: boolean | null | undefined, plugin?: boolean | null | undefined } | null | undefined, customCommands?: Array<{ __typename?: 'CustomCommands', id: string, name: string, description: string }> | null | undefined, music?: { __typename?: 'Music', plugin?: boolean | null | undefined, channel?: string | null | undefined, immortal?: boolean | null | undefined } | null | undefined, logs?: Array<{ __typename?: 'Logs', name: string, action: string }> | null | undefined } };
...
export type UpdatePrefixMutation = { __typename?: 'Mutation', updatePrefix: { __typename?: 'GuildConfig', guildId: string, prefix?: string | null | undefined } };
...
export type UpdateAutoModMutation = { __typename?: 'Mutation', updateAutoMod: { __typename?: 'GuildConfig', guildId: string, moderation?: { __typename?: 'Moderation', autoMod?: boolean | null | undefined, plugin?: boolean | null | undefined } | null | undefined } };
 ...
 * });
 */
export function useOwnerGuildsQuery(baseOptions?: Apollo.QueryHookOptions<OwnerGuildsQuery, OwnerGuildsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<OwnerGuildsQuery, OwnerGuildsQueryVariables>(OwnerGuildsDocument, options);
      }
export function useOwnerGuildsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<OwnerGuildsQuery, OwnerGuildsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<OwnerGuildsQuery, OwnerGuildsQueryVariables>(OwnerGuildsDocument, options);
        }
export type OwnerGuildsQueryHookResult = ReturnType<typeof useOwnerGuildsQuery>;
export type OwnerGuildsLazyQueryHookResult = ReturnType<typeof useOwnerGuildsLazyQuery>;
export type OwnerGuildsQueryResult = Apollo.QueryResult<OwnerGuildsQuery, OwnerGuildsQueryVariables>;
 ...
 * });
 */
export function useGuildConfigQuery(baseOptions: Apollo.QueryHookOptions<GuildConfigQuery, GuildConfigQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GuildConfigQuery, GuildConfigQueryVariables>(GuildConfigDocument, options);
      }
export function useGuildConfigLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GuildConfigQuery, GuildConfigQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GuildConfigQuery, GuildConfigQueryVariables>(GuildConfigDocument, options);
        }
export type GuildConfigQueryHookResult = ReturnType<typeof useGuildConfigQuery>;
export type GuildConfigLazyQueryHookResult = ReturnType<typeof useGuildConfigLazyQuery>;
export type GuildConfigQueryResult = Apollo.QueryResult<GuildConfigQuery, GuildConfigQueryVariables>;
export const UpdatePrefixDocument = gql`
  ...
  updatePrefix(updatePrefix: $prefix) {
    ...
    `;
export type UpdatePrefixMutationFn = Apollo.MutationFunction<UpdatePrefixMutation, UpdatePrefixMutationVariables>;
 ...
 * });
 */
export function useUpdatePrefixMutation(baseOptions?: Apollo.MutationHookOptions<UpdatePrefixMutation, UpdatePrefixMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdatePrefixMutation, UpdatePrefixMutationVariables>(UpdatePrefixDocument, options);
      }
export type UpdatePrefixMutationHookResult = ReturnType<typeof useUpdatePrefixMutation>;
export type UpdatePrefixMutationResult = Apollo.MutationResult<UpdatePrefixMutation>;
export type UpdatePrefixMutationOptions = Apollo.BaseMutationOptions<UpdatePrefixMutation, UpdatePrefixMutationVariables>;
export const UpdateAutoModDocument = gql`
  ...
  updateAutoMod(updateAutoMod: $autoMod) {
    ...
    `;
export type UpdateAutoModMutationFn = Apollo.MutationFunction<UpdateAutoModMutation, UpdateAutoModMutationVariables>;
 ...
 * });
 */
export function useUpdateAutoModMutation(baseOptions?: Apollo.MutationHookOptions<UpdateAutoModMutation, UpdateAutoModMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateAutoModMutation, UpdateAutoModMutationVariables>(UpdateAutoModDocument, options);
      }
export type UpdateAutoModMutationHookResult = ReturnType<typeof useUpdateAutoModMutation>;
export type UpdateAutoModMutationResult = Apollo.MutationResult<UpdateAutoModMutation>;
export type UpdateAutoModMutationOptions = Apollo.BaseMutationOptions<UpdateAutoModMutation, UpdateAutoModMutationVariables>;