...
const navigationMenuTriggerStyle =
  'group inline-flex h-10 w-max items-center justify-center rounded-md bg-transparent py-2 px-4 text-sm font-medium transition-colors hover:bg-theme-primary/60 focus:bg-theme-primary/60 disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-theme-secondary data-[state=open]:bg-theme-primary/60 data-[active]:bg-theme-primary/10 data-[active]:bg-theme-primary'
