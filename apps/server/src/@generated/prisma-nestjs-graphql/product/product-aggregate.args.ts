...
import { ProductOrderByWithRelationAndSearchRelevanceInput } from './product-order-by-with-relation-and-search-relevance.input'
...
export class ProductAggregateArgs {
  ...
  @Field(() => [ProductOrderByWithRelationAndSearchRelevanceInput], {
    nullable: true,
  })
  orderBy?: Array<ProductOrderByWithRelationAndSearchRelevanceInput>
