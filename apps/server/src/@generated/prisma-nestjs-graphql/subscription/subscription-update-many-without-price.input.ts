...
@InputType()
export class SubscriptionUpdateManyWithoutPriceInput {
    ...
    @Field(() => [SubscriptionUpsertWithWhereUniqueWithoutPriceInput], {nullable:true})
    ...
    @Field(() => [SubscriptionUpdateWithWhereUniqueWithoutPriceInput], {nullable:true})
    @Type(() => SubscriptionUpdateWithWhereUniqueWithoutPriceInput)
    update?: Array<SubscriptionUpdateWithWhereUniqueWithoutPriceInput>;

    @Field(() => [SubscriptionUpdateManyWithWhereWithoutPriceInput], {nullable:true})
