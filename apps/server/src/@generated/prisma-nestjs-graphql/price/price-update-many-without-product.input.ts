...
@InputType()
export class PriceUpdateManyWithoutProductInput {
  ...
  @Field(() => [PriceUpsertWithWhereUniqueWithoutProductInput], {
    nullable: true,
  })
